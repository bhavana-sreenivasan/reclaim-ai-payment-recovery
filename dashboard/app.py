...
Loader also transparently falls back to a gzipped twin of any CSV
(e.g. `payment_attempts.csv.gz`) if the plain `.csv` isn't present —
handy if you keep the data folder compressed for GitHub.
"""
